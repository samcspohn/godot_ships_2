...
const RELOAD_MOD:  float = 0.90   # -10% reload time
const SPREAD_MOD:  float = 0.90   # -10% base spread
...
func _init() -> void:
	...
	tooltip_stats = [
		...
		{"stat": "Priority Target Focus Speed", "value": "-10%",                   "positive": true},
	]
...
func _a(ship: Ship) -> void:
	...
	(sec_ctrl.target_mod.dynamic_mod as TargetMod).base_spread *= 0.9
