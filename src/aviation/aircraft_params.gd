...
@export var ordnance_reload_time: float = 25.0 # time after landing before the squadron has rearmed and can be launched again; only paid when it actually dropped its ordnance
