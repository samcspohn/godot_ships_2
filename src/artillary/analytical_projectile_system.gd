...
class_name GDProjectilePhysicsWithDrag
...
static func calculate_launch_vector(start_pos: Vector3, target_pos: Vector3, projectile_speed: float,
	...
	var initial_result = GDProjectilePhysics.calculate_launch_vector(start_pos, target_pos, projectile_speed)
...
static func calculate_leading_launch_vector(start_pos: Vector3, target_pos: Vector3, target_velocity: Vector3,
	...
	var result = GDProjectilePhysics.calculate_launch_vector(start_pos, target_pos, projectile_speed)
